...
{
    internal class SpeedBoostF : Module
    {
        internal override string Name => "SpeedBoost (FAST)";
        internal override string Category => "Movement";
        internal override string ToolTip => "Gives you speed";
        ...
        internal override void OnStateChanged()
        {
            if (State)
            {
                ...
                GorillaLocomotion.Player.Instance.maxJumpSpeed = 12.04004503450f;
            }
